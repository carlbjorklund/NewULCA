...
namespace NewULCA.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ScheduledId,Image,ChannelId,AirDate,StartTime,EndTime,LengthTimeSpan,ShowId,Sorting")] Schedules schedules)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ScheduledId,Image,ChannelId,AirDate,StartTime,EndTime,LengthTimeSpan,ShowId,Sorting")] Schedules schedules)
        {
            if (ModelState.IsValid)
            {
